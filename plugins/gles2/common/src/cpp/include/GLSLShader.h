#ifndef AE_GLES2_GLSL_SHADER_H
#define AE_GLES2_GLSL_SHADER_H
 ...
 */
class GLSLShader:public GLESError {
    /** */
    enum {
        /** Indicates no shader. */
        NO_SHADER
...
public:
     ...
     */
    GLSLShader(GLenum shaderType_):GLESError(),shaderType(shaderType_),
        glShader(NO_SHADER) {
    }
