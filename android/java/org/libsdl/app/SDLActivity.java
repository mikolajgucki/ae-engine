...
public class SDLActivity extends Activity {
    ...
    public static void loadLibraries() {
       for (String lib : getLibraries()) {
           Log.v(TAG,"Loading native library " + lib);
    ...
    /**
     * AEEngine
     * Called when a fatal error occurs in the native code.
     */
    public static void aeThrowException(final String message) {
