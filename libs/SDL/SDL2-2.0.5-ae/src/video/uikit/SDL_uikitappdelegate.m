...
// Must be defined in the application which is on top of SDL.
extern void SDL_iPhoneMain();
extern void SDL_DidFinishLaunchingWithOptions(UIApplication *application,
...
int main(int argc, char **argv)
{
    ...
    /* Call to give opportunity to register notification observers and receive application events. */
    SDL_iPhoneMain();    
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    SDL_SetMainReady();
    SDL_DidFinishLaunchingWithOptions(application,launchOptions);    
...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SDL_didRegisterForRemoteNotificationsWithDeviceToken" object:nil userInfo:@{@"deviceToken":deviceToken}];
}

- (void)application:(UIApplication *)application didFailToRegisterForRemoteNotificationsWithError:(NSError *)error {
    NSLog(@"didFailToRegisterForRemoteNotificationsWithError: %@", error);
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SDL_didFailToRegisterForRemoteNotificationsWithError" object:nil userInfo:@{@"error":error}];
}

- (void)application:(UIApplication*)application didReceiveRemoteNotification:(NSDictionary*)userInfo {
    NSLog(@"didReceiveRemoteNotification");
    [[NSNotificationCenter defaultCenter] postNotificationName:@"SDL_didReceiveRemoteNotification" object:nil userInfo:userInfo];
}
