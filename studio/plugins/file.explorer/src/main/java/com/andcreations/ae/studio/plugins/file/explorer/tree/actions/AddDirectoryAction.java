 ...
 */
class AddDirectoryAction extends AddItemAction {
    /** */
    private BundleResources res = new BundleResources(AddDirectoryAction.class);
    ...
    private void create() {
        create(res.getStr("action.name"),
            Icons.getIcon(DefaultIcons.DIRECTORY,DefaultIcons.DECO_ADD),
